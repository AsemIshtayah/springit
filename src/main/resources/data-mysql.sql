...
VALUES (11,NOW(),NOW(),null,null,'Getting Started with spring boot 2', 'https://therealdavega.com/spring-boot-2');

INSERT INTO comment (id,created_by,creation_date,last_modified_by,last_modified_date,body,link_id)
VALUES (12,null,NOW(),null,NOW(),'What an awesome idea for a course!', 1);
